...
export default function AddOfferPage() {
    ...
    const [offerType, setOfferType] = useState<string>('free_shipping');
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        try {
            ...
            toast.error("حدث خطأ أثناء إضافة العرض: " + message);
            setIsPending(false);
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer group">
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    defaultChecked={offerType === 'free_shipping'}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className={`relative border-2 border-dashed rounded-xl p-8 text-center transition-all cursor-pointer ${fileError ? 'border-red-300 bg-red-50' : 'border-slate-200 dark:border-slate-700 hover:bg-slate-50'}`}>
                            ...
                            <p className="text-xs text-slate-400 mt-2">سيتم ضغط الصورة تلقائياً قبل الرفع</p>
                        </div>
                        {fileError && (
